      ...
      <div class="col">
        ...
        <div class="card text-center" style="width: 18rem;">
          <div class="card-body">
            ...
            <p class="card-text" style="font-size:medium; font-family:'Times New Roman', Times, serif; ">“Para trinta e cinco garotas, a Seleção é a chance de uma vida. É a oportunidade de ser alçada a um mundo de vestidos deslumbrantes e joias valiosas. De morar em um palácio, conquistar o coração do belo príncipe Maxon e um dia ser a rainha.
      ...
      <div class="col">
        ...
        <div class="card text-right" style="width: 18rem;">
          <div class="card-body">
            ...
            <p class="card-text" style="font-size:medium; font-family:'Times New Roman', Times, serif; ">Miles Halter é um adolescente fissurado por célebres últimas palavras - e está cansado de sua vidinha segura e sem graça em casa. Vai para uma nova escola à procura daquilo que o poeta François Rabelais, quando estava à beira da morte, chamou de o 'Grande Talvez'. Muita coisa o aguarda em Culver Creek, inclusive Alasca Young. Inteligente, engraçada, problemática e extremamente sensual, Alasca levará Miles para o seu labirinto e o catapultará em direção ao Grande Talvez.</p>
          </div>
        </div>
      </div> <!-- fecha  col com cards -->
      <div class="col"></div> <!-- Fecha col -->
